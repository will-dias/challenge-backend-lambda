...
@patch("src.lambda_function.upload_catalog_s3")
@patch("src.lambda_function.get_catalog")
...
@patch("src.lambda_function.upload_catalog_s3")
@patch("src.lambda_function.get_catalog", return_value=None)
...
@patch("src.lambda_function.process_record")
